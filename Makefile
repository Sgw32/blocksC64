...
SRC = src/blocks64k_kick3d.asm
BUILD_SRC = .build/blocks64k_kick3d_acme.asm
...
$(BUILD_SRC) $(KICK_BUILD_SRC): $(SRC) src/blocks64k_user.asm src/blocks64k_resources.asm scripts/normalize_kick3d_for_acme.py $(KICK_SRC)
